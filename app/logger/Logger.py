...
class Logger:
    LOG_PATH = '/root/projects/FilesSorter/logs/'  # При запуске из другого файла к относительному пути добавляется путь до того файла. Поэтому, используем абсолютный.
